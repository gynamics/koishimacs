...
#+begin_src emacs-lisp
  (use-package ox
    :commands (my:update-sitemap my:org-post-html)
    :config
    (defvar my/org-blog-post-dir
      (my:strong-directory "/wsp/edu/blog.gynamics.top/posts/"))
    (defvar my/org-blog-js-prefix "/js/")
    (defvar my/org-blog-rsrc-prefix "/resources/")

    (autoload 'json-read-file "json")
    (defun my:update-sitemap (key &optional title date tags)
      "Update the json item with KEY and value TITLE, data, TAGS."
      (interactive)
      (let* ((f (file-name-concat my/org-blog-post-dir "index.json"))
        ...
        (setf (gethash key h)
              `((title . ,(or title "No Title"))
                (date . ,(or date (current-time-string)))
                (tags . ,(vconcat tags))))
      ...
      (dlet ((org-html-head-include-default-style nil)
             ...
             (org-html-preamble-format
              `((,org-export-default-language
                 ,(format
                   (concat "<div id=\"head-container\">Hello, world!</div>"
                           "<script src=\"%s\"></script>")
             ...
             (org-html-postamble-format
              `((,org-export-default-language
                 ,(format
                   (concat "<div id=\"tail-container\">&copy All Rights Reserved.</div>"
                           "<script src=\"%s\"></script>")
        ...
        (let ((title (org-get-title))
          ...
          (when (file-exists-p f)
            (let ((d my/org-blog-post-dir)
              ...
              (my:update-sitemap
               (concat base ".html") title
               (format-time-string
                "%a, %d %b %Y %T %Z" ;; rfc7231 format
