...
#+begin_src emacs-lisp
  ;; refresh quickstart file automatically after update
  (advice-add 'package-menu-execute :after
              #'(lambda () (package-quickstart-refresh)))
...
#+begin_src emacs-lisp
  ;; not integrated to lsp-haskell yet
