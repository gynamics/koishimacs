...
#+begin_src emacs-lisp
  (use-package org
    ...
    (org-babel-load-languages '((emacs-lisp . t) (gnuplot . t) (plantuml . t) (dot . t) (shell . t) (latex . t) (lilypond . t)))
...
#+begin_src emacs-lisp
  (use-package message
    :custom
    (message-directory (my:strong-directory (concat user-emacs-directory "Mail/")))
    )
  ...
  (use-package sendmail
    ...
    (mail-signature-file (concat mail-default-directory ".signature"))
    )
