...
#+begin_src emacs-lisp
  (use-package ox
    :commands (my:blog-sitemap-update my:blog-rsync my:org-blog-post)
    :config
    ...
    (defvar my/org-blog-tail
      (format (concat "<div id=\"tail-container\">&copy 2026 gynamics</div>"
                      "<script src=\"%s\"></script>")
