...
* About
My personal Emacs configuration. This is a *minimal, standalone* branch cut from v6.0.1 .

Read [[file:koishimacs.org::*preface][koishimacs.org:Prelude:preface]] if you are interested in my ideas.

* Features
- A sweet logo (hand-drawn, converted with ~chafa~, original character by /Team Shanghai Alice/)
...
1. First, make sure that your network is smooth, and clone this repository.
   ...
   #+begin_src sh
     git clone https://github.com/gynamics/koishimacs -b mini
   #+end_src
...
4. Finally, do remaining steps to complete the installation.
